    ...
    <div class="inner-1450">
      ...
      <div class="pricing-section">
        ...
        <div class="pricing-note bg-white">
          <p class="navy" style="font-size:clamp(12px,1.25vw,14px); line-height:1.7;">※上記はマンション・戸建ての換気ダクト（浴室、洗面所、トイレ、レンジフード、部屋）の料金（税込）です。飲食店のフードダクトは別途お見積もりが必要です。グリスフィルターは別途¥5,000追加となります。電気・水道・ガスをお借りします。事前にうかがった状態と著しく異なる場合、追加料金が発生したり作業ができない場合がございます。追加料金が発生する場合は作業実施前にお伝えいたします。</p>
        </div>
      </div>
    </div>
  </section>
